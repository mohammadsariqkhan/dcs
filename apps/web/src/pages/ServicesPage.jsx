...
import {
  ...
  CloudCog, Shield, Settings, ArrowRight, CheckCircle2, Bot
} from 'lucide-react';
...
const SectionHeader = ({ label, title, subtitle }) => (
  <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="mb-10">
    ...
    <h2 className="text-2xl md:text-3xl font-800 text-slate-900 dark:text-white mb-3"
      style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 800 }}>
      {title}
    </h2>
    {subtitle && <p className="text-slate-500 dark:text-slate-400 max-w-2xl text-base">{subtitle}</p>}
  </motion.div>
);
...
const ServicesPage = () => {
  ...
  const aiMLServices = [
    {
      ...
      description: 'Build ML models that forecast trends, customer behavior, and business outcomes with high accuracy.',
      benefits: ['Revenue forecasting', 'Demand prediction', 'Churn prevention'],
      technologies: ['Scikit-learn', 'XGBoost', 'Prophet']
    },
  ...
  const advancedAnalyticsServices = [
    ...
    { icon: Star, title: 'Data & AI Consulting', description: 'Unlock the value of your enterprise data with specialized architectural advisory and design services.', benefits: ['Technology selection roadmap', 'ROI optimization', 'Data strategy audit'], technologies: ['Databricks', 'Snowflake', 'AWS', 'Azure'] }
  ];
  ...
  const agenticAIServices = [
    { icon: Bot, title: 'Autonomous AI Agents', description: 'Deploy agents that autonomously parse goals, break down tasks, and execute actions to achieve business objectives.', benefits: ['Goal decomposition', 'Iterative execution', 'Self-reflection'], technologies: ['LangChain', 'OpenAI', 'LangGraph'] },
    { icon: Workflow, title: 'Multi-Agent Orchestration', description: 'Coordinate networks of specialized AI agents working together on complex multi-stage tasks.', benefits: ['Specialized roles', 'State management', 'Collaborative workflows'], technologies: ['LangGraph', 'CrewAI', 'AutoGen'] },
    { icon: Zap, title: 'Tool Calling & Integrations', description: 'Connect models securely to internal database APIs, search engines, and document tools.', benefits: ['Real-time actions', 'Sandbox safety', 'Structured JSON outputs'], technologies: ['MCP', 'FastAPI', 'Pydantic'] },
  ];
  ...
  const serviceGroups = [
    {
      ...
      subtitle: 'Build intelligent systems that learn, adapt, and deliver measurable business value',
      services: aiMLServices,
      bg: false
    },
    { id: 'agentic-ai', label: 'Agentic AI', title: 'Agentic AI Systems', subtitle: 'Deploy autonomous and multi-agent systems built to handle complex multi-step workflows', services: agenticAIServices, bg: true },
    { id: 'data-science', label: 'Data Science', title: 'Data Science', subtitle: 'Extract actionable insights through statistical rigor and advanced analytics', services: dataScienceServices, bg: false },
    { id: 'data-analytics', label: 'Analytics', title: 'Data Analytics', subtitle: 'Transform data into visual insights with interactive dashboards and reporting', services: analyticsServices, bg: true },
    { id: 'advanced-analytics', label: 'Advanced Analytics', title: 'Advanced Analytics', subtitle: 'Go beyond descriptive analytics with predictive and prescriptive insights', services: advancedAnalyticsServices, bg: false },
    { id: 'data-engineering', label: 'Engineering', title: 'Data Engineering', subtitle: 'Build scalable data infrastructure that powers analytics and ML at scale', services: dataEngineeringServices, bg: true },
    { id: 'cloud-solutions', label: 'Cloud', title: 'Cloud Solutions', subtitle: 'Migrate, modernize, and optimize your infrastructure on leading cloud platforms', services: cloudServices, bg: false },
  ];
    ...
    <>
      ...
      <main>
        ...
        <section className="pt-32 pb-20 gradient-hero relative overflow-hidden">
          ...
          <div className="container-custom relative z-10">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-800 text-white mb-5" style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 800 }}>
        ...
        {serviceGroups.map((group, gi) => {
          const pagePath =
            group.id === 'ai-ml' ? '/services/ai-ml' :
              group.id === 'data-engineering' ? '/services/data-engineering' :
                group.id === 'cloud-solutions' ? '/services/cloud-solutions' :
                  group.id === 'advanced-analytics' ? '/services/advanced-analytics' :
                    group.id === 'data-analytics' ? '/services/data-analytics' :
                      group.id === 'agentic-ai' ? '/services/agentic-ai' :
                        group.id === 'data-science' ? '/services/advanced-analytics' : '/services';

          return (
            <section key={gi} id={group.id} className={`py-16 ${group.bg ? 'bg-[hsl(214_32%_97%)] dark:bg-slate-900/50' : 'bg-white dark:bg-transparent'}`}>
